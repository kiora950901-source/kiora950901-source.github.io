...
lib.ssMetadata = [
		{name:"B2A21作業09_2_atlas_1", frames: [[0,0,623,434],[0,436,278,280],[581,467,153,408],[625,0,180,465],[280,669,192,322],[0,718,231,138],[280,436,299,231],[474,877,312,103],[474,669,54,128]]}
];
...
(lib.CachedBmp_18 = function() {
	this.initialize(ss["B2A21作業09_2_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.B2A21作業092 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(269.8,317.3,213.5,569.7);
// library properties:
lib.properties = {
	id: '9697ADF28A2EE7499B334948E8A288D2',
	width: 640,
	height: 480,
	fps: 30,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/圖層3.png?1766373585414", id:"圖層3"},
		{src:"images/B2A21作業09_2_atlas_1.png?1766373585383", id:"B2A21作業09_2_atlas_1"}
	],
	preloads: []
};
...
an.compositions['9697ADF28A2EE7499B334948E8A288D2'] = {
